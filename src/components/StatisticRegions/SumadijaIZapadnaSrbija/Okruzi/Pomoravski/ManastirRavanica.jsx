  ...
  return (
    <div className="placeBackground">
      ...
      <p style={{ paddingTop: "50px" }}>
        Manastir Ravanica, sa crkvom Vaznesenja Gospodnjeg, predstavlja
        zadužbinu srpskog vladara kneza Lazara i podignut je između sedamdesetih
        i osamdesetih godina XIV veka. O podizanju ovog manastira sačuvane su
        dve katorske povelje, obe u obliku kasnijih prepisanih verzija. Prema
        takozvanom bolońskom prepisu, ravanička povelja je izdana 1376/77.
        godine, dok prema vrdničkom prepisu datira iz 1381. godine. Ipak, na
        osnovu žitija svetog Romila, koji je živeo u neposrednoj blizini
        Ravanice i bio je sahranjen u manastiru nakon svoje smrti 1375. godine,
        ...
        kao utvrđeni grad. Prvo je počela gradnja pirga, a zatim je formisan
      ...
      <p>
        ...
        podvig srpskog viteza legendarno ime - Miloša Obilića - bio je poznat i
        ...
        Lazar Hrebeljanović, kasnije uzdignut na carsko dostojanstvo, u
        ...
        Bogom i opredeljuje se za Carstvo nebesko, birajući mučeničku smrt u
        ...
        za hrišćansku veru, koja je poistovećena sa nacionalnim identitetom.
        Kosovsku zemlju su Srbi smatrali svetim tlo, gde nevernici odstupaju
      ...
      <p>
        ...
        samostalnost - samodržavnost, nazivajući sebe „gospodarom zemlje srpske“
        i to „po milosti Božjoj“, te postaje Stefan: „Stefan knez Lazar“. On se
        ...
        kroz istoriju. Nakon pogibije kneza Lazara na Kosovu 28. juna (na
        Vidovdan) 1389. godine, i prenosa njegovih moštiju iz crkve Vaznesenja u
        Prištini u Ravanicu 1392. godine, gde se i danas nalaze, manastir
        ...
        književnosti i pismenosti sve do kraja XVII veka. Tu je stvorena
        ...
        bila i neka vrsta monaške škole, ali se tek od XVII veka poznaju imena
      ...
      <p>
        ...
        Manastir Ravanica je rušen i paljen 1396, 1398. i 1436. godine. Nakon
        ...
        krajine 1686/7. godine, crkva je pretrpela ozbiljna oštećenja, uništene
        ...
        1689-1690. godine, pridružujući se velikoj seobi Srba pod patrijarhom
        Arsenijem III Čarnojevićem. Pešice su se povukli sve do Senta, u blizini
      ...
      <p>
        ...
        karakteristikama, označava početak razvoja moravske škole. Crkva je
        ...
        vreme kralja Milutina. Trolisna osnova postavila je temelj za dalji
