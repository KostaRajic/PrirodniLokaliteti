  ...
  return (
    <div className="placeBackground">
      ...
      <p style={{ paddingTop: "50px" }}>
        Vrnjačka Banja, poznata kao "kraljica banjskog turizma", oduvek je bila
        prepoznata po svojim lekovitim izvorima. Područje je bilo naseljeno još
        ...
        Lekovitost vode u Vrnjačkoj Banji prvi su prepoznali Rimljani, koji su
        na tom mestu izgradili lečilište Aquae Orcinae i izvor Fons Romanus.
        Veruje se da su i keltsko pleme Skordisci, koji su prethodili
        Rimljanima, koristili vodu iz izvora za piće, kupanje i lečenje.
        Rimljani su, prema tome, bacali zlatnike u bunare, a otkriveni su i
        ostaci bazena za kupanje, što govori o značaju banjske vode u tom
        vremenu. Takođe, postoji verovanje da su južni Sloveni bili svesni
        lekovitih svojstava ovih voda kada su se naselili na Balkanu, ali podaci
        o tom periodu su oskudni. Prema nekim legendama, Turski begovi i spahije
      ...
      <p>
        ...
        vlasti, knez Miloš Obrenović angažovao je geologa Herdera da istraži
        ...
        upoređujući je sa Karlovim Varima u Češkoj. Iako je voda imala
        ...
        Trstenika, koji su se udružili i 1868. godine osnovali Osnovatelno
        fundatorsko društvo kiselo vruće vode u Vrnjcima. Kupili su zemljište sa
        izvorima lekovite vode, koja je do tada bila u rukama lokalnih gazda, i
        započeli izgradnju prvih objekata. Sam naziv "Vrnjačka Banja" potiče od
      ...
      <p>
        ...
        gostionica koju je 1885. godine otvorio Kosta Petrović Rakica. Prema
        rečima Jelene Borović, kustosa muzeja, ključna godina za razvoj Vrnjačke
        Banje bila je 1888. Tada je general Jovan Belimarković, ugledna ličnost
      ...
      <p>
        ...
        dolini reke Zapadne Morave, a sa svih strana je okružena planinama.
        Planina Goč štiti je sa juga, istoka i zapada, dok je sa severa
        zaštićena Gledićkim planinama. Banja se nalazi na 220 metara nadmorske
        visine, a kroz nju prolaze reke Lipovačka i Vrnjačka. Nedaleko od
        Vrnjačke Banje, na 25 km uzvodno, smeštene su Podunavačke bare,
        popularna destinacija za ljubitelje rečnih predela i sportski ribolov.
        Klima u ovom području je umereno oblačna, sa najvećim padavinama u junu
        i oktobru, dok je septembar mesec sa najmanje kiše. Vetrovi su retki
        zahvaljujući planinama koje okružuju banju, pa čak 170 dana u godini
        nema vetra. Banja je prepoznatljiva po bujnoj vegetaciji, jer se nalazi
        u šumsko-planinskom području Kopaonika. Dominiraju bogate šume, pretežno
        lipe, ali tu su i borove i jelove šume, kao i mnogo zimzelenih biljaka.
      ...
      <p>
        ...
        vremena. Međutim, prvi banjski lekar u novijoj istoriji bio je Josif
        Pančić. Na njegov savet, Pavle Mutavdžić je koristio vodu iz Vrnjaca,
        što je pokrenulo razvoj i gradnju prvih banjskih objekata. Na području
        Vrnjačke Banje nalazi se sedam izvora mineralne vode: Topla voda,
        Snežnik, Slatina, Jezero, Beli izvor, Borjak i Vrnjačko vrelo. Među
        njima se nalaze i topli i hladni izvori, a za lečenje se koriste Topla
        voda, Snežnik, Slatina i Jezero. Dve vrste vode se čak flaširaju i
        prodaju kao mineralne vode. Topla voda je jedinstvena na svetu jer je
        njena temperatura ista kao temperatura ljudskog tela, 36,5°C. Ovaj izvor
        pripada kategoriji alkalnih ugljeno-kiselih toplih voda. Topla voda je
        prvi izvor koji je u potpunosti prilagođen banjskom turizmu. Već 1883.
        godine izgrađen je Kursalon, objekat za prijem gostiju, a zidano
      ...
      <p>
        ...
        parka u Srbiji i regionu – Akva parka Raj. Ovaj impozantni kompleks,
        ...
        „kamikaza“ koji se penje do 30 metara u vis, hidromasažne bazene sa
        ...
        avanturu na površini od 2.000 m², a sve to upotpunjuje restoran koji se
      ...
      <p>
        ...
        kulturnom nasleđu. Zbog toga što je naseljena još u praistoriji, ovaj
        kraj krase brojni spomenici i tragovi ranijih civilizacija. Jedan od
        najznačajnijih nalazišta je rimski bunar Fons Romanus, koji je slučajno
        otkriven tokom radova na kaptaži 1924. godine. Osim pažljivo isklesane
        stene sa izvorom, pronađeni su i ostaci prvobitnog bazena. Najbolje
        svedočenje o korišćenju mineralne vode iz Vrnjačke Banje u rimskom
        periodu čine novčići koji su pronađeni u blizini bunara i bazena,
        datirajući od vladavine cara Avgusta do Valentinijana. Iznad Rimskog
        bunara podignuta je staklena piramida 1989. godine, dok je bunar bio
        sakriven od očiju javnosti betonskim pločama sve do toga vremena, od II
        svetskog rata.
      </p>
      ...
      <p>
        ...
        stalnoj postavci „Ladarište – praistorija Vrnjaca“ Zavičajnog muzeja.
        Zavičajni muzej je najstarija građevina (građen od 1888) u Vrnjačkoj
        banji posle crkve i nalazi se iznad izvoda Topla voda. Poznati je i kao
        zamak Belimarković. Zavičajni muzej je otkupljen od porodice
        Belimarković 1968. godine sa namenom za kulturu. Do tada su u njemu
        živeli naslednici čuvenog generala Belimarkovića, koji je krajem 19.
        veka popularizovao Vrnjačku banju, sagradivši letnjikovac – Zamak
        Belimarković.
      </p>
    </div>
  );
