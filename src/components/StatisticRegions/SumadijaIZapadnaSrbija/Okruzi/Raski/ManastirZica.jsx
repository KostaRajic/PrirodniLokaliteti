  ...
  return (
    <div className="placeBackground">
      ...
      <p style={{ paddingTop: "50px" }}>
        U prelepoj dolini Ibra i Raške, nedaleko od današnjeg grada Kraljeva,
        nalazi se manastir Žiča. Mesto na kojem je podignut ovaj manastir,
        ...
        povezivanje teritorija koje je Nemanjić samo nešto ranije pripojio
        Raškoj i neposredna eksploatacija plodnih područja koja su tada bila
        dodeljena Crkvi na korišćenje i upravljanje svakako su bili među
        osnovnim razlozima. Manastir Žiča je osnovan sa jasnom namerom da
        postane sedište Arhiepiskopije, gde će se krunisati kraljevi i
        postavljati arhiepiskopi Srpske Pravoslavne Crkve. Arhiepiskopija je
        trebalo da bude podjednako udaljena od vizantijskog Carigrada i
        latinskog Rima. Osim toga, među velikim srpskim manastirima, Žiča je
        tada bila najudaljenija od eventualnih opasnosti koje su dolazile sa
        jugoistoka, bilo od križarskog latinskog carstva ili od Bugarske.
        ...
        presudni od razloga bezbednosti. Samo ime Žiča govori o kraju koji je
        bogat žitom.
      </p>
      ...
      <p>
        ...
        utvrđeno posrednim putem na osnovu podataka koje donose Domentijan i
        Teodosije, biografi Svetog Save. Oni beleže da je gradnju Spasovog doma
        započeo Stefan Nemanjić još kao veliki župan, u vreme kada je njegov
        mlađi brat bio starešina Studenice. Sava je, prema rečima Teodosija,
        nadgledao zidanje Spasovog hrama. Na osnovu tih podataka zaključuje se
        da je Žiča podignuta u periodu od 1206. do Savinog odlaska u Hilandar
        ...
        Svetom Savi, dobijena samostalnost Srpske Pravoslavne Crkve, i Žiča je
        postala sedište srpske Arhiepiskopije. Naime, kao arhimandrit Studenice,
        Sveti Sava je 1219. krenuo u Nikeju, tadašnju prestonicu Vaseljenskog
        Patrijarha. Patrijarh Manojlo Saranten Haritopul i car Teodor I Laskaris
        dodeljuju arhimandritu Savi Akt o autokefalnosti Srpske Crkve,
        hirotonisući ga na Cveti 1219. godine za prvog srpskog arhiepiskopa.
        ...
        svojim bratom Stefanom šta treba "za završetak Svete velike
      ...
      <p>
        ...
        Stefana i njegovog sina Radoslava, iz druge i treće dekade XIII veka,
        ...
        Žičkoj Eparhiji dao Prvovenčani kralj sa svojim najstarijim sinom,
      ...
      <p>
        ...
        Prvovenčani kralj je Žiči darovao 57 sela i zaselaka, što znači više od
        ...
        neposrednoj blizini Žiče, u Hvosnu, u Crnoj Gori. Zanimljivo je da i
        ...
        planine Željin, Kotlenik, Slane poljane, Javorje i Lukovica. Vladari
        koji su nasledili Stefana Prvovenčanog darivali su Arhiepiskopiju
        imanjima na Kosovu i Drenici. Od sredine XIII veka, Arhiepiskop je
        ...
        grad Maglič, utvrđeni dvorski kompleks podignut na dvadesetak kilometara
      ...
      <p>
        ...
        Verovatno se radilo o napadu braće Drmana i Kudelina, gospodara
        Braničeva, koji su sa Tatarima i Kumanima pustošili Srbiju.
        Arhiepiskopija je prebačena u Peć. <br /><br /> Opustošenu Žiču obnovio je
        Arhiepiskop Jevstatije II (1292. - 1309.), a najveći posao bio je obnova
        ...
        nije povratila svoj prvobitni sjaj. I Jevstatijev naslednik, Sava III
        (1309. - 1316.), zajedno sa kraljem Milutinom, obnovio je najveći deo
        ...
        krajevima preko reke Save. Godine 1562. mitropolit smederevski Zaharije
        ...
        1805. godine, Žiča je bila uvrštena među zapuštene manastire. Karađorđe
        ...
        kada je po odluci Svetog Sinoda iz 1854. godine, episkop šabački
        Joanikije Nešković premesten na praznu Eparhiju žičku i započeo radove
        na obnovi manastira. Sve do 1928. godine to je bio najveći obim radova
        na njegovoj obnovi.
      </p>
    </div>
  );
