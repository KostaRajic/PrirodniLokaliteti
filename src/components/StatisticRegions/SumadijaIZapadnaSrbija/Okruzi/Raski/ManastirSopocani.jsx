  ...
  return (
    <div className="placeBackground">
      ...
      <p style={{ paddingTop: "50px" }}>
        ...
        reke Raške, po kojoj se srednjovekovna srpska država nazivala Raškom.
        Među visokim i divljim brdima, sa strašnim kamenim liticama, u blizini
        svoje prestonice Rasa, kralj Uroš I (1243-1276) podigao je hram Svetoj
        Trojici, nad samim izvorom reke Raške. Naziv Sopoćani dolazi od
        staroslovenske reči „sopot“, što znači izvor. Manastir je verovatno
      ...
      <p>
        Kralj Uroš I, sin Stefana Prvovenčanog i unuk Nemanji, bio je vešt i
        sposoban vladar.
        <br />
        ...
        razvijao crkvenu organizaciju i učvrstio kult Nemanji i Save, osnivače
        dinastije i samostalne crkve. Tokom njegove vladavine, dolaskom nemačkih
        rudara "Sasa" u Srbiju, otvoreni su rudnici srebra, bakra i olova, što
        ...
        Svetog Simeona i Svetog Save, dela koja pripadaju najvećim ostvarenjima
        srpske srednjovekovne književnosti. Svetog kralja u plemenitim
      ...
      <p>
        ...
        opstale zahvaljujući izuzetnoj kvaliteti izrade. Ipak, zlatni listići
