  ...
  return (
    <div className="placeBackground">
      ...
      <p style={{ paddingTop: "50px" }}>
        ...
        okružen prelepim brdovitim pejzažima. Grad ima bogatu istoriju i
        kulturu, sa značajnim znamenitostima poput Starog grada, srednjovekovne
        tvrđave koja svedoči o njegovom strateškom značaju kroz vekove. Užice je
        takođe poznato po svojoj ulozi u Narodnooslobodilačkoj borbi tokom
        Drugog svetskog rata, kada je bilo centar Užičke republike, kratkotrajne
        slobodne teritorije. Danas se u gradu može posetiti Muzej užičkog kraja,
        ...
        Nacionalni park Tara, reke, planine i jezera čine ovu oblast atraktivnom
        ...
        kuhinji, gde se posebno ističu specijaliteti poput komplet lepinje. Grad
        je povezan železnicom i drumskim saobraćajem, što ga čini lako
      ...
      <p>
        ...
        potpunosti pregrađuje korito reke Đetinje na mestu gde ona izlazi iz
        klisure i ulazi u mirnu kotlinu. Utvrđenje je podignuto na visokom i
        teško pristupačnom grebenu, opasanom rekom Đetinjom sa tri strane. Strme
        litice, visoke i do 50 metara, prirodno štite grad sa zapadne, južne i
        ...
        tvrđava je bila posed vlastelinske porodice Vojinović, a između 1366. i
        1373. godine pripadala je Nikoli Altomanoviću. Dubrovački istoričar
      ...
      <p>
        ...
        postalo značajna vojna baza. U vreme Prvog srpskog ustanka, grad je
      ...
      <p>
        ...
        temeljac za izgradnju hidrocentrale na Đetinji, koja je Užicu donela
        ...
        napredak omogućio je osnivanje bankarskih ustanova poput Građanske
        štedionice (1884), Trgovačke banke (1908) i Užičke kreditne zadruge
        (1911). Telegrafska služba uvedena je 1860. godine, a telefonska 1904,
      ...
      <p>
        ...
        KPJ. U njihovim podzemnim prostorijama, poznatim kao Trezor, nalazilo se
      ...
      <p>
        ...
        Užica, smešten je u selu Zlakusa, na 185 kilometara od Beograda.
        ...
        tako i stranih. U okviru parka nalazi se i sedište Etno udruženja
        Zavičaj, osnovanog s ciljem očuvanja kulture, tradicije, običaja i
      ...
      <p>
        ...
        Turci. Nalazila se u delu grada poznatom kao Stara Varoš ili Carina.
        Tokom turske vladavine, crkva je spaljena, a na njenim temeljima
        podignuta je nova bogomolja 1828. godine, za vreme kneza Miloša
        Obrenovića. Crkva sv. Marka čuva bogatu zbirku ikona koje svedoče o
        njenoj dugoj i značajnoj istoriji. Među njima se posebno izdvajaju
        italokritska dela iz 16. veka, poput prefinjene predstave Hrista
        Pantokratora na zlatnoj pozadini. Jednako vredna je i ikona Bogorodice
        sa Hristom i malim Svetim Jovanom, koja se pripisuje radionici iz
      ...
      <p>
        ...
        Nastala je radom ponornica koje nestaju u Drežničkoj dolini, a nakon
      ...
      <p>
        ...
        Bioštanske Banje do Užica, ukupne dužine od oko 15 kilometara, sa
        ...
        severu se nastavlja na Kremansku kotlinu, gde se na nadmorskoj visini od
        712 metara, spajanjem Konjske reke, Bratišne reke, Užičkog potoka i
        Tomića potoka, formira reka Đetinja. Klisura se završava kod užičkog
        Starog grada, gde se otvara u prostraniju kotlinu u kojoj je smešten
        grad Užice.
      </p>
    </div>
  );
