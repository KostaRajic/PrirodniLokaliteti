  ...
  return (
    <div className="placeBackground">
      ...
      <p style={{ paddingTop: "50px"}}>
        ...
        površina je prekrivena peskom. Zbog varijacija u sposobnosti tla da
        upija vodu i hranljive materije, na ovom području se razvijaju različiti
        oblici reljefa. Na nekim mestima možete pronaći zelene površine sa
        bogatom vegetacijom, guste šume, ali i pustinjske pejzaže, što čini ovu
      ...
      <p style={{ marginTop: "-10px" }}>
        ...
        pravi fenomen, a posebno upečatljiva su na Zagajičkim brdima, gde na
        vrhu malih uzvišenja često možete videti samo jedno drvo, što stvara
        jedinstvenu sliku. Ova peščara je 1977. godine proglašena specijalnim
        rezervatom prirode, i danas predstavlja jedno od najposebnijih i
      ...
      <p style={{ marginTop: "-10px" }}>
        ...
        Zagajičkih brda. Ova brda pripadaju Specijalnom rezervatu prirode
        Deliblatska peščara i nalaze se u opštini Bela Crkva, u blizini sela
        Grebenac. Zanimljiv je i istorijski aspekt, jer su brda nekada bila deo
        teritorije sela Zagajica. Međutim, došlo je do dogovora prema kojem su
        Zagajička brda pripala Grebencu, dok je Grebenac u zamenu ustupio deo
        svoje teritorije Zagajici. Iako se brda danas nazivaju Zagajička, deo su
        teritorije Grebenca, što povremeno izaziva nezadovoljstvo među meštanima
      ...
      <p style={{ marginTop: "-10px" }}>
        ...
        vožnju nekoliko kilometara. Na levoj strani puta, nakon nekoliko
        kilometara, uočićete Zagajićka brda. Ovdje se asfalt završava i počinje
        zemljani put. Još jedan znak da ste na pravom putu biće tabla koja
      ...
      <p style={{ marginTop: "-10px" }}>
        ...
        kojima se nalaze i retki endemi kao što su banatski božur, stepski
        božur, Pančićev pelin, šerpet i oko 20 vrsta orhideja. Fauna ovog kraja
        je bogata i raznolika, a među najlepšim pticama koje nastanjuju ovo
        područje su pčelarica, pupavac, vodomar, orao krstaš i banatski soko.
        Obala i ade na Dunavu predstavljaju jedina stabilna gnezdilišta u Srbiji
        za retke vrste poput laste bregunice, male bele čaplje i malog
        kormorana. Deliblatska peščara je dom i za mnoge sisavce, uključujući
        jelene, srne, divlje svinje, ali i male stepske vrste poput slepog
        kučeta i stepskog skočimiša, koji se u Srbiji mogu naći samo u ovom
        specifičnom regionu.
      </p>
      ...
      <p style={{ marginTop: "-10px" }}>
        ...
        sportistima, ali i svima koji žele potpuni odmor i uživanje u prirodnim
        lepotama ovog jedinstvenog prirodnog predela.
      </p>
    </div>
  );
};
