    ...
    <>
      ...
      <div className="placeBackground">
        ...
        {switchLanguage === 'en' ?
          ...
          :
          (
            <><h2>Vračevgajsko Lake</h2><section lang="en">
              <p>
            ...
            </section><img srcSet={`${vracevgajskoJezero33} 450w, ${vracevgajskoJezero3} `} alt="Vračevgajsko Lake 2" /><section lang="en">
                <p>
              ...
              </section><img srcSet={`${vracevgajskoJezero44} 450w, ${vracevgajskoJezero4} `} alt="Vračevgajsko Lake 3 Bela Crkva" /><section lang="en">
                <p>
