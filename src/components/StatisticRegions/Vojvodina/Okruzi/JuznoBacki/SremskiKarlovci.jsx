      ...
      <div className="placeBackground">
        ...
        {switchLanguage === 'rs' ? (
          ...
          (
            ...
            <><section lang="en">
              <p>
            ...
            </section><img srcSet={`${karlovci22} 450w, ${karlovci2} `} alt="Sremski Karlovci 2" /><section lang="en">
                <p>
              ...
              </section><img srcSet={`${karlovci33} 450w, ${karlovci3} `} alt="Sremski Karlovci 3" /><section lang="en">
                <p>
              ...
              </section><img srcSet={`${karlovci44} 450w, ${karlovci4} `} alt="Sremski Karlovci 4" /><section lang="en">
                <p>
                ...
                srcSet={`${karlovci55} 450w, ${karlovci5} `}
                alt="Sremski Karlovci 5" /><section lang="en">
                <p>
