        ...
        {switchLanguage === 'en' ?
          ...
          (
            <>
              ...
              <img srcSet={`${pancevo22} 450w, ${pancevo2} `} alt="City of Pančevo 2" />
              ...
              <img srcSet={`${pancevo11} 450w, ${pancevo1} `} alt="Pančevo National Museum" />
              ...
              <img srcSet={`${pancevo55} 450w, ${pancevo5} `} alt="Pančevo Nature Park Ponjavica" />
