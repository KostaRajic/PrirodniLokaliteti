    ...
    <>
      ...
      <div className="placeBackground">
        ...
        {switchLanguage === 'rs' ?
          (
            <>
              <h1 style={{ color: "white" }}>Manastir Jazak</h1>
