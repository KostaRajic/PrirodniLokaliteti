export const KosovoIMetohijaTekst = {
    name: "Kosovo i Metohija",
    mainText: `Kosovo i Metohija su regioni bogati prirodnim lepotama, kulturnim nasleđem i istorijskim značajem. Ovi krajevi su poznati po prelepim planinama, rekama, manastirima i arheološkim nalazištima. Kosovo je dom spektakularnih prirodnih fenomena, dok Metohija nudi autentičnu atmosferu, bogatu tradiciju i srdačno gostoprimstvo. Ovi regioni su ključni centri za turizam, poljoprivredu i stočarstvo. Glavni grad regiona je Priština, a značajni gradovi su Peć, Đakovica i Prizren. Ovi krajevi obiluju kulturnim manifestacijama, narodnim običajima i gastronomski su među najzanimljivijima na Balkanu.`,
    topic1: `Turistički i prirodni lokaliteti`,
    text1: `
  Kosovo i Metohija su dom mnogim prirodnim lepotama i turističkim lokalitetima, među kojima se izdvajaju:`,
    text11: `* Pećka Patrijaršija – Jedan od najvažnijih manastira na Balkanu, pod zaštitom UNESCO-a, koji je centar duhovnosti i istorije srpske crkve.`,
    text12: `* Gračanica – Manastir iz 14. veka, takođe pod zaštitom UNESCO-a, poznat po izuzetnim freskama i istorijskom značaju.`,
    text13: `* Đakovica – Grad poznat po svojoj istoriji, tradiciji i lepoj arhitekturi, kao i brojnim kulturnim manifestacijama.`,
    text14: `* Prokletije – Planinski masiv koji se proteže duž granice između Kosova i Crne Gore, poznat po divljim pejzažima, vrhovima i rekama, idealno za planinarenje i avanturizam.`,
    text15: `* Šar planina – Jedna od najlepših planina na Balkanu, poznata po svojim vrhovima, rekama, jezerima i bogatoj flori i fauni.`,
    text16: `* Brezovica – Popularna skijaška destinacija, smeštena na Šar planini, koja privlači ljubitelje zimskih sportova.`,
    text17: `* Manastir Visoki Dečani – Jedan od najlepših srpskih manastira, pod zaštitom UNESCO-a, sa bogatim freskama i istorijskim značajem.`,
