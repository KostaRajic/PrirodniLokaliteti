...
const ManastirGracanica = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Pristinski/Gracanica"))
...
const TvrdjavaNovoBrdo = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Pristinski/TvrdjavaNovoBrdo"))
const PrizrenskiOkrug = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Prizrenski/PrizrenskiOkrug"))
const Prizren = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Prizrenski/Prizren"))
const ManastirSvetihArhangela = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Prizrenski/ManastirSvetihArhangela"))
const VodopadMirusa = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Prizrenski/VodopadMirusa"))
...
const UrosevackiOkrug = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Uroevacki/UrosevackiOkrug"))
const Urosevac = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Uroevacki/Urosevac"))
const Brezovica = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Uroevacki/Brezovica"))
const Ljuboten = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Uroevacki/Ljuboten"))
const GnjilanskiOkrug = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Gnjilanski/GnjilanskiOkrug"))
const Gnjilane = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Gnjilanski/Gnjilane"))
const ManastirUbozac = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Gnjilanski/ManastirUbozac"))
const TvrdjavaPodgradje = lazy(() => import("./components/StatisticRegions/KosovoIMetohija/Okruzi/Gnjilanski/PodgradjeTvrdjava"))
const VratnaIZamna = lazy(() => import("./components/StatisticRegions/IstocnaIJuznaSrbija/Okruzi/Borski/VratnaIZamna"))
    ...
    <Suspense fallback={<Spinner />}>
      <Layout>
        ...
        <Routes>
          ...
          />
          <Route
            path="/:lang/istocna-srbija-tekst-modal/istocna-i-juzna-srbija/borski-okrug/vratnaizamna"
            element={<Suspense fallback={<div>Loading...</div>}><VratnaIZamna /></Suspense>}
          />
          <Route
